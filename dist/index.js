...
const settings = __importStar(__nccwpck_require__(607));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.update = exports.formatSettings = exports.getTemplate = exports.getToolchainsTemplate = void 0;
const core = __importStar(__nccwpck_require__(924));
const path_1 = __importDefault(__nccwpck_require__(622));
const fs_1 = __importDefault(__nccwpck_require__(747));
const xmldom_1 = __nccwpck_require__(434);
const xml_formatter_1 = __importDefault(__nccwpck_require__(261));
function getToolchainsTemplate() {
    return getTemplate('../template', 'toolchains.xml');
}
exports.getToolchainsTemplate = getToolchainsTemplate;
function getTemplate(filepath, filename) {
    const templatePath = path_1.default.join(__dirname, filepath, filename);
...
function formatSettings(templateXml) {
    const string = new xmldom_1.XMLSerializer().serializeToString(templateXml);
    // format xml to standard format
    return (0, xml_formatter_1.default)(string, {
        indentation: '  ',
...
function updateToolchains(templateXml) {
...
function format(xml, options = {}) {
    ...
    const parser = __nccwpck_require__(570);
...
var htmlEntity = __nccwpck_require__(191);
var sax = __nccwpck_require__(348);
var XMLReader = sax.XMLReader;
var ParseError = sax.ParseError;
var DOMImplementation = exports.DOMImplementation = __nccwpck_require__(40).DOMImplementation;
exports.XMLSerializer = __nccwpck_require__(40).XMLSerializer ;
